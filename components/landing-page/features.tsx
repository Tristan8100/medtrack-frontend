...
import { Calendar, Users, Clock, FileText, Shield, Activity } from 'lucide-react'
                        ...
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center justify-center">
                                    <div className="relative">
                                        <Calendar className="size-20 text-blue-600 dark:text-blue-500" strokeWidth={1.5} />
                                ...
                                <h2 className="mt-6 text-center text-3xl font-semibold">Easy Booking</h2>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Clock className="m-auto size-16 text-blue-600 dark:text-blue-500" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition dark:text-white">Real-time Queue</h2>
                                    <p className="text-foreground">Monitor your position in line and estimated wait time from anywhere.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <div className="relative bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/40 dark:to-indigo-950/40 rounded-lg p-6 h-32">
                                        <FileText className="size-12 text-blue-600 dark:text-blue-400 mb-2" strokeWidth={1.5} />
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Digital Records</h2>
                                    <p className="text-foreground">Secure and accessible patient health records at your fingertips.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-zinc-800 transition dark:text-white">Track Health Trends</h2>
                                        <p className="text-foreground">Monitor community health statistics and appointment patterns.</p>
                                    </div>
                                </div>
                                    ...
                                    <svg
                                        ...
                                        <defs>
                                            <linearGradient
                                                ...
                                                <stop
                                                    className="text-blue-500/20 dark:text-blue-500/35"
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">Secure & Private</h2>
                                        <p className="text-foreground">Your health information is protected with end-to-end encryption and secure storage.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-400">Verified</span>
                                            <div className="ring-background size-7 ring-4 relative">
                                                <div className="size-full rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-white text-xs font-bold">
                                                    👤
                                                </div>
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ring-4 relative">
                                                <div className="size-full rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white text-xs font-bold">
                                                    🔒
                                                </div>
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-400">Encrypted</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-purple-50 dark:bg-purple-950/30 border-purple-200 dark:border-purple-800 text-purple-700 dark:text-purple-400">Protected</span>
                                            <div className="ring-background size-7 ring-4 relative">
                                                <div className="size-full rounded-full bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center text-white text-xs font-bold">
                                                    ✓
                                                </div>
                                            </div>
                                        </div>
